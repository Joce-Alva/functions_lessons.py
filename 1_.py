...
#def happy_birthday(name,age):  # Perameter
 #   print(f"Happy birthday to {name}!")
 #   print("You are {age} years old!")
 #   print("Happy birhtday to you!")
 #   print()  

#happy_birthday("Bro", 20)      # Arugument: real data that goes into the perameter
#happy_birthday("Steve", 30)      # Happy birthday = call function
...
display_invoice("IDK", 100.01, "01/02")
display_invoice("GirlCode", 100.01, "01/02")
...
full_name = create_name("SpongeBob", "Sparepants")
print(full_name)
